...
namespace Young\HttpClient\Request\Traits;

use Exception;
use Stringy\Stringy;
use Young\HttpClient\Result\Result;
use Young\HttpClient\Exception\ClientException;

/**
 * Trait RetryTrait
 *
 * @package Young\HttpClient\Request\Traits
 */
trait RetryTrait
{
    /**
